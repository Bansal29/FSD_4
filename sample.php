...
<div class="container">
    ...
    <form id="form" method="post" action="" onsubmit="valform()">
        ...
        <input type="submit" name="submit" id="subb" value="Submit" disabled>
    </form>
    ...
    <form method="post" action="">
        ID: <input type="text" name="delete_email" required><br>
    ...
    <?php
    $sql = "SELECT `Stud_id`,`Name`,`School`,`Address`,`Email`,`Mobile`,`Password`,`State`,`City`,`Country`,`PinCode` FROM `student`";
